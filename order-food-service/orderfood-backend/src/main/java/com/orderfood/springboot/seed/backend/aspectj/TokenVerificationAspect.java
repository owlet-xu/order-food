package  com.orderfood.springboot.seed.backend.aspectj;

import com.alibaba.fastjson.JSONObject;
import  com.orderfood.springboot.seed.common.configs.XseedSettings;
import  com.orderfood.springboot.seed.common.exception.BusinessException;
import  com.orderfood.springboot.seed.common.exception.ResultStatus;
import  com.orderfood.springboot.seed.common.redis.RedisUtil;
import  com.orderfood.springboot.seed.common.util.HttpServletContextHolder;
...
public class TokenVerificationAspect {
    ...
    @Pointcut("execution(public *  com.orderfood.springboot.seed.bz1.controller..*.*(..))")
